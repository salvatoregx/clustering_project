...
class TestTransform(unittest.TestCase):
    ...
    def test_engineer_features(self):
        # Create dummy data
        data = [
            {"store_id": "s1", "size_m2": 100.0, "total_revenue": 1000.0, "storage_capacity_m2": 50.0},
            {"store_id": "s2", "size_m2": 0.0, "total_revenue": 500.0, "storage_capacity_m2": 20.0}, # Missing size (0.0)
            {"store_id": "s3", "size_m2": 200.0, "total_revenue": 2000.0, "storage_capacity_m2": 80.0}
        ]
